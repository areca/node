...
/*
The Joi plugin was also installed with package.json and
it's useful to validate input data that is sent to us
by the user (in this case, to validate that
the provided POST request is valid).
*/
