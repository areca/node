...
/*
To use the url above, put marvel api keys to .env file.
Above code uses dotenv to use them.

Instead of marvel api (just to skip authentication part) use following url (static json) mimics the marvel api response
